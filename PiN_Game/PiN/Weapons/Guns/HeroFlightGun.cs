...
namespace PiN
{
    ...
    class HeroFlightGun : Gun
    {
        ...
        /// </summary>
        public HeroFlightGun(Texture2D loadedTexture, GameCharacter theShooter)
        ...
        protected override void LoadContent()
        {
            ...
            {
                bullets[i] = new GameObject(weaponWielder.Level.Content.Load<Texture2D>("Sprites/HeroFlight/Bullet"));
            }
        }
